...
function ENT:Draw()
	...
	cam.Start3D2D(self:GetPos() + Vector(0,0, 25), a , 0.074)	
		draw.SimpleText("Night-vision device (NVG)","Trebuchet24",0,-75,Color(255,255,255,255) , 1 , 1)
		draw.SimpleText("[E] to equip NVG","Trebuchet24",0,-50,Color(255,255,255,255) , 1 , 1)
